        ...
        rx.el.div(
            ...
            rx.el.div(
                rx.el.a(
                    "Ingresar",
                    href=_app_href("/"),
                    class_name="inline-flex items-center justify-center rounded-xl border-2 border-indigo-600 bg-white px-4 py-2 text-sm font-semibold text-indigo-600 transition-colors hover:bg-indigo-50",
                ),
                rx.el.a(
                    "Iniciar prueba gratis",
                    href=_app_href("/registro"),
                    class_name="inline-flex items-center justify-center rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-emerald-700",
                ),
