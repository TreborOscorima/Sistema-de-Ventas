...
BUTTON_STYLES = {
    ...
    "icon_danger":  f"p-1.5 text-red-500 hover:text-red-600 hover:bg-red-50 active:bg-red-100 {RADIUS['md']} {TRANSITIONS['fast']}",
    "icon_primary": f"p-1.5 text-indigo-500 hover:text-indigo-700 hover:bg-indigo-50 active:bg-indigo-100 {RADIUS['md']} {TRANSITIONS['fast']}",
    "icon_ghost":   f"p-1.5 text-slate-500 hover:text-slate-700 hover:bg-slate-100 active:bg-slate-200 {RADIUS['md']} {TRANSITIONS['fast']}",
    "icon_warning": f"p-1.5 text-amber-500 hover:text-amber-600 hover:bg-amber-50 active:bg-amber-100 {RADIUS['md']} {TRANSITIONS['fast']}",
    "icon_success": f"p-1.5 text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 active:bg-emerald-100 {RADIUS['md']} {TRANSITIONS['fast']}",
