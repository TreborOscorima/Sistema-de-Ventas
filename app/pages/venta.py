                ...
                rx.el.div(
                    ...
                    rx.el.div(
                        action_button(
                            ...
                            variant="primary" if State.payment_card_type == "Credito" else "secondary",
                            icon="credit-card",
                        ),
                        action_button(
                            "Debito",
                            on_click=lambda: State.set_card_type("Debito"),
                            variant="primary" if State.payment_card_type == "Debito" else "secondary",
                            icon="credit-card",
                        ),
                ...
                rx.el.div(
                    ...
                    rx.el.div(
                        action_button(
                            ...
                            variant="primary" if State.payment_wallet_choice == "Yape" else "secondary",
                            icon="smartphone",
                        ),
                        action_button(
                            "Plin",
                            on_click=lambda: State.choose_wallet_provider("Plin"),
                            variant="primary" if State.payment_wallet_choice == "Plin" else "secondary",
                            icon="qr-code",
                        ),
                        action_button(
                            "Otro",
                            on_click=lambda: State.choose_wallet_provider("Otro"),
                            variant="primary" if State.payment_wallet_choice == "Otro" else "secondary",
                        ),
                        class_name="flex flex-wrap gap-3",
                    ),
                    rx.cond(
                    ...
                    rx.el.div(
                        ...
                        rx.el.div(
                            action_button(
                                "Credito",
                                on_click=lambda: State.set_card_type("Credito"),
                                variant="primary_sm" if State.payment_card_type == "Credito" else "secondary_sm",
                                icon="credit-card",
                            ),
                            action_button(
                                "Debito",
                                on_click=lambda: State.set_card_type("Debito"),
                                variant="primary_sm" if State.payment_card_type == "Debito" else "secondary_sm",
                                icon="credit-card",
                            ),
                    ...
                    rx.el.div(
                        ...
                        rx.el.div(
                            action_button(
                                "Yape",
                                on_click=lambda: State.choose_wallet_provider("Yape"),
                                variant="primary_sm" if State.payment_wallet_choice == "Yape" else "secondary_sm",
                                icon="smartphone",
                            ),
                            action_button(
                                "Plin",
                                on_click=lambda: State.choose_wallet_provider("Plin"),
                                variant="primary_sm" if State.payment_wallet_choice == "Plin" else "secondary_sm",
                                icon="qr-code",
                            ),
                            action_button(
                                "Otro",
                                on_click=lambda: State.choose_wallet_provider("Otro"),
                                variant="primary_sm" if State.payment_wallet_choice == "Otro" else "secondary_sm",
                            ),
