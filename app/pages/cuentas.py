          ...
          rx.el.div(
            ...
            rx.cond(
              ...
              pagination_controls(
                ...
                on_goto=lambda p: State.set_debtors_page(p),
                page_window=State.debtors_page_window,
              ),
              rx.fragment(),
            ),
            class_name="flex flex-col gap-4",
          ...
          rx.el.div(
            ...
            rx.cond(
              ...
              pagination_controls(
                ...
                on_goto=lambda p: State.set_installments_page(p),
                page_window=State.installments_page_window,
              ),
              rx.fragment(),
            ),
            class_name="flex flex-col gap-4",
