    ...
    return rx.el.div(
        ...
        rx.el.div(
            ...
            rx.el.button(
                ...
                class_name="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-md bg-indigo-600 text-white hover:bg-indigo-700 min-h-[42px]",
            ),
                ...
                rx.el.div(
                    ...
                    rx.el.div(
                        ...
                        rx.el.button(
                            ...
                            class_name="flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 shadow min-h-[44px]",
                        ),
