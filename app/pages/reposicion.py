...
def _status_badge(status: rx.Var[str]) -> rx.Component:
    ...
    return rx.match(
        ...
        ("sent",      rx.el.span("Enviado",   class_name=BADGE_STYLES["info"])),
        ("received",  rx.el.span("Recibido",  class_name=BADGE_STYLES["success"])),
        ("cancelled", rx.el.span("Cancelado", class_name=BADGE_STYLES["neutral"])),
        ...
        rx.el.div(
            ...
            rx.el.div(
                ...
                rx.el.select(
                    ...
                    rx.el.option("Recibidos", value="received"),
                    rx.el.option("Cancelados",value="cancelled"),
