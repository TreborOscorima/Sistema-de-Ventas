      ...
      rx.radix.primitives.dialog.content(
        ...
        rx.el.div(
          ...
          rx.el.textarea(
            ...
            auto_focus=True,
            class_name="w-full px-3 py-2 text-sm bg-white border border-slate-200 rounded-md focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 min-h-[100px]",
          ),
          class_name="flex flex-col gap-1",
        ),
        rx.divider(color="slate-100"),
